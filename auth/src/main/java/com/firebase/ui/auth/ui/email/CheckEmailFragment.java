                            ...
                            new OnSuccessListener<ProviderQueryResult>() {
                                ...
                                public void onSuccess(ProviderQueryResult result) {
                                    ...
                                    if (providers == null || providers.isEmpty()) {
                                        ...
                                        else if (mHelper.getFirebaseAuth().getCurrentUser() != null)
                                        {
                                            // User is already signed in (upgrading from anonymous account)
                                            FirebaseUser currentUser = mHelper.getFirebaseAuth().getCurrentUser();
