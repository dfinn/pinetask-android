...
public class RegisterEmailActivity extends AppCompatBase implements
    ...
    public void onExistingEmailUser(User user) {
        ...
        {
            // User is already signed in anonymously: can't use an existing email address. Must set up a new account to link with anonymous account.
            Toast.makeText(this, R.string.error_user_collision_email, Toast.LENGTH_LONG).show();
        }
        else
        {
    ...
    public void onExistingIdpUser(User user) {
        ...
        if (firebaseAuth.getCurrentUser() != null)
        {
            // User is already signed in anonymously: can't use an existing account. Must set up a new account to link with anonymous account.
            Toast.makeText(this, R.string.error_user_collision_other, Toast.LENGTH_LONG).show();
        }
        else
        {
