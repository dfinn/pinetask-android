...
public class WelcomeBackPasswordPrompt extends AppCompatBase implements View.OnClickListener {
    ...
    private void next(final String email, final String password)
    {
        ...
        signInWithUsernameAndPassword(firebaseAuth, email, password);
    }

    /**  Sign in with known email and the password provided **/
    private void signInWithUsernameAndPassword(FirebaseAuth firebaseAuth, final String email, final String password)
    {
                ...
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        if (authCredential == null) {
                            ...
                            AuthUI.getInstance().linkCredentials(authResult.getUser(), authCredential, TAG, mActivityHelper, mIdpResponse);
                        }
                    }
                })
