...
public class AuthUI {
    ...
    /** Link the credentials supplied with the user account. **/
    public void linkCredentials(FirebaseUser user, AuthCredential credentialsToLink, String tag, final ActivityHelper activityHelper, final IdpResponse idpResponse)
    {
        user.linkWithCredential(credentialsToLink)
                .addOnFailureListener(new TaskFailureLogger(tag, "Error signing in with credential " + credentialsToLink.getProvider()))
