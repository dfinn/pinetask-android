...
public class TutorialActivity extends AppIntro
{
    ...
    public void onSlideChanged(@Nullable Fragment oldFragment, @Nullable Fragment newFragment)
    {
        ...
        if (newFragment instanceof VideoPlayerFragment)
        {
            VideoPlayerFragment videoPlayerFragment = (VideoPlayerFragment) newFragment;
            videoPlayerFragment.startPlayback();
        }
        else if (newFragment instanceof TutorialImageAndTextFragment)
        {
